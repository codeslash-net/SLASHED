...
**Version:** 0.4.6.0 (pre-1.0, API still evolving — see [Path to 1.0](docs/SPEC.md#path-to-10) for what needs to settle before semver kicks in). [`ROADMAP.md`](ROADMAP.md) lists what's not yet shipped.
